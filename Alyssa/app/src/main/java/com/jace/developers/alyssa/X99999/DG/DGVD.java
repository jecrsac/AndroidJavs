...
public class DGVD extends DialogFragment {

    private DGVD.X311603390 mCallback;
    ...
    public interface X311603390 {
        void onSelectedDate(String XG14ESSFX);
    }
    ...
    public AlertDialog createLoginDialogo() {
        ...
        @SuppressLint("InflateParams") View v = inflater.inflate(R.layout.dg_dates, null);

        xFECHA = (TextView) v.findViewById(R.id.SGFX);
