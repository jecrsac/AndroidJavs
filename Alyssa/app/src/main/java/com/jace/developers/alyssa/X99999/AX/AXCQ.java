...
public class AXCQ extends RecyclerView.Adapter<AXCQ.MessageViewHolder> implements View.OnClickListener {

    private Context c;
    private List<X77940> items;
    private View.OnClickListener listener;

    public AXCQ(Context context, List<X77940> items) {
        this.items = items;
        c=context;
    }

    @Override
    public AXCQ.MessageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dg_itemadapter, parent, false);
        v.setOnClickListener(this);
        return new AXCQ.MessageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(AXCQ.MessageViewHolder holder, int position) {
