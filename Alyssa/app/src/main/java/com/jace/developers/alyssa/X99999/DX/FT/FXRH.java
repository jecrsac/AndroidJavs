...
class FXRH extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    FXRH(View itemView, Context context) {
        super(itemView);
        ...
        /** RUTAS **/
        ROOT = XJCX.X165008671()+"/Alyssa/Fotos/"+IXSN+"/";
    ...
    public void onClick(View view) {
        ...
        if (xFOTO != null) { partsColl = xFOTO[getAdapterPosition()+1]; }
    ...
    private void serverUpdate(){
        if (file.exists()){ new ServerUpdate().execute(); }else{ Toast.makeText(context, "ERROR "+file, Toast.LENGTH_LONG).show(); }
    }
    ...
    private void uploadFile(String filename){
        try {
            ...
            X51827 htfu = new X51827(XBIN+"?CR="+IXSN+"&TP=90891","noparamshere", filename);
            htfu.doStart(fis);
